...
lazy val root = (project in file("."))
  .settings(
    ...
    //libraryDependencies += "com.acme.common" % "commonclass" % "1.0" % "compile" from "file:///home/spark/fuzzy/fuzzylogic/target/scala-2.12/fuzzylogic_2.12-0.1.0-SNAPSHOT.jar",
  )
